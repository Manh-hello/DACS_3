...
public final class ActivityCartBinding implements ViewBinding {
  ...
  private ActivityCartBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnBack,
      @NonNull AppCompatButton btnBuy, @NonNull ConstraintLayout layout,
      @NonNull ConstraintLayout main, @NonNull ProgressBar progress, @NonNull RecyclerView rvList,
      @NonNull Spinner spinnerGender, @NonNull Spinner spnPay, @NonNull TextView tvDiscount,
      @NonNull TextView tvPay, @NonNull TextView tvTotal) {
  ...
  public static ActivityCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCartBinding((ConstraintLayout) rootView, btnBack, btnBuy, layout, main,
          progress, rvList, spinnerGender, spnPay, tvDiscount, tvPay, tvTotal);
    }
