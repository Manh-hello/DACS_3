...
public final class ActivityOrderBinding implements ViewBinding {
  ...
  private ActivityOrderBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnBack,
      @NonNull LinearLayout layout, @NonNull ConstraintLayout main, @NonNull TabLayout tabLayout,
  ...
  public static ActivityOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrderBinding((ConstraintLayout) rootView, btnBack, layout, main, tabLayout,
          viewPager);
    }
