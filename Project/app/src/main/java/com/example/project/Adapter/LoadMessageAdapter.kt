...
import com.example.project.databinding.ReceiveBinding
import com.example.project.databinding.SentBinding
import com.google.firebase.database.core.view.View

class LoadMessageAdapter(private val cusId: String, private val list: MutableList<Chat>) :
    ...
    override fun getItemViewType(position: Int): Int {
        return if (list[position].send == cusId) TYPE_SENT else TYPE_RECEIVE
    }
