...
import com.example.project.databinding.FragmentDaXacNhanBinding
import com.example.projectmanage.Model.Entity.OrderDetail
import kotlin.getValue

class DaXacNhanFragment : Fragment() , ClickBTNOrder{
    private lateinit var binding: FragmentDaXacNhanBinding
    private var isHave = 0
    ...
    override fun onCreateView(
        ...
        binding = FragmentDaXacNhanBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myViewModel.listOrder.observe(viewLifecycleOwner) { orders ->
            ...
            myViewModel.loadOrderDetailAlready(ids)
        }
        myViewModel.mapOrderDetails.observe(viewLifecycleOwner) { map ->
            ...
            adapter = OrderAdapter(orders.toMutableList(), map, this@DaXacNhanFragment)
            if (orders.isEmpty()) {
